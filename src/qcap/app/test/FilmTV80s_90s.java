 ...
 */
public class FilmTV80s_90s extends TransformationTester {
...
//        testSourceSchema("tv__film_new_release_source_schema_4.txt");
        testTargetSchema("tv_film_80s_90s_target_schema_1.txt");
    }
