 ...
 */
public class FilmTVNotableTypeTester extends TransformationTester {

    public static List<Integer> q_tv_text;
    public static List<Integer> q_television_text;
    public static List<Integer> q_movie_text;
    public static List<Integer> q_film_text;

    static {
        q_tv_text = Arrays.asList(43891, 44456, 45755, 47936, 44384, 45123, 46367, 47030, 48640, 48685, 43254, 44178, 44757, 45264, 45990, 46448, 46733, 48395, 49034, 49119, 49253, 49969, 50321, 44124, 46079, 46551, 47906, 49189);
        q_film_text = Arrays.asList(44882, 50041, 43019, 43267, 43580, 45110, 45192, 45347, 45516, 45596, 47052, 47059, 48368, 48442, 48788, 48964, 49375, 49512, 49708, 49730, 49800, 49863, 48494);
        q_movie_text = new ArrayList<Integer>();
        q_television_text = new ArrayList<Integer>();
        //        q_tv_text = Arrays.asList(43254, 44178, 44757, 45264, 45990, 46448, 46733, 48395, 48494,
//                49034, 49119, 49253, 49969, 50321);

        //        q_television_text = Arrays.asList(44124, 46079, 46551, 47906, 49189);
//        q_film_text = Arrays.asList(43891, 44456, 44882, 45755, 47936, 50041);
//        q_movie_text = Arrays.asList(43019, 43267, 43580, 44384,
...
//        testSourceSchema("tv_and_or_film_source_schema_7.txt");
    ...
    public static void testSourceSchemaDuplicate(String resultFile) {
        ...
        Collection<Query> q_tv_text_obj = Query.findById(q_tv_text);
        Collection<Query> q_television_text_obj = Query.findById(q_television_text);
        Collection<Query> q_film_text_obj = Query.findById(q_film_text);
        Collection<Query> q_movie_text_obj = Query.findById(q_movie_text);
